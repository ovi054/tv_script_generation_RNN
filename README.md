# tv_script_generation_RNN

Udacity Deep Learning nanodegree TV Script generation project

Introduction In this project, you'll generate your own TV scripts using RNNs. The Neural Network you'll build will generate a new, "fake" TV script.
